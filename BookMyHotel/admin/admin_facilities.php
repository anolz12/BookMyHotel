...
<head>
    ...
    <title>Manage Facilities - BookMyHotel Admin</title>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar bg-dark">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="admin_facilities.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-light">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2 h-font">Manage Facilities</h1>
                </div>

                <div class="card shadow border-0">
                    <div class="card-body">
                        <p>Facilities management page</p>
                        <p>You can add, edit, and manage hotel facilities like:</p>
                        <ul>
                            <li>Swimming Pool</li>
